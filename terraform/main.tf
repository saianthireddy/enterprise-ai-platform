...
# ---------------------------------------------------------------------------
# ECS Fargate cluster running the backend + frontend containers
# ---------------------------------------------------------------------------
  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        { name = "VECTOR_BACKEND", value = "pinecone" },
      ]
      secrets = [
...
resource "aws_appautoscaling_target" "backend" {
  max_capacity       = 12
  min_capacity       = var.desired_backend_count
...
# ---------------------------------------------------------------------------
# Data stores: Postgres (RDS) + Redis (ElastiCache) + S3 for document uploads
# ---------------------------------------------------------------------------
